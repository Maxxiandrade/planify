...
const Confirmation = () => {
  ...
  const servicioElegido = servicios.services.find(
  ...
  return (
    <>
      <div className="border border-slate-300 flex flex-col items-start rounded-md">
        ...
        <br />
        <h1 className="mb-3 ml-5">
          Fecha: {date} {timeSelected}
        </h1>
      </div>
      ...
      <div className="flex space-x-28 justify-center my-3">
        <Link to="/schedule">
          <button className="bg-slate-500 py-2 px-2 text-white rounded-sm">
            Anterior
          </button>
        </Link>
        <button
          className="bg-slate-600 py-2 px-2 text-white rounded-sm"
